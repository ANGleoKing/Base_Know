...
public class test {
    public static void main(String[] args) throws Exception {
        ...
        Class aClass = Class.forName("JavaBase.reflect.AnnotationTest");
            ...
            for(Method method : methods){
                if(method.isAnnotationPresent(AnnotationDemo1.class)){
                    ...
                    int result = (int) method.invoke(aClass.newInstance());
    ...
    public void DemoTest() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException, NoSuchFieldException, ClassNotFoundException {
        ...
        Class cClass = Class.forName("JavaBase.reflect.DEMO");
        ...
        int ageVal  = (int) method.invoke(demo);
